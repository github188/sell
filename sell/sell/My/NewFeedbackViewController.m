...
@interface NewFeedbackViewController ()
...
- (void)clickRightBtn:(UIButton *)sender
{
    if ([_tv.text isEqualToString:@""]) {
        [[[UIAlertView alloc] initWithTitle:@"提示" message:@"请填写反馈内容" delegate:nil cancelButtonTitle:@"知道了" otherButtonTitles:nil, nil] show];
    }
    // 验证手机号等等
